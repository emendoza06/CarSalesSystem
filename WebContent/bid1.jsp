<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import = "com.user.searchPreferences" %>
    ...
    <%@page import = "com.servlet.bid1Servlet" %>
<%searchPreferences bid = (searchPreferences)session.getAttribute("bid"); %>
...
<div class = "container">
	...
	<div class = "col-md-4">
		...
		<br>
		<form action = "bid1Servlet" method = "get">
		<div class = "form-group">
		<br>
 <input type = "text" name = "bid" placeholder = "Starting bid $30,000"><br>
