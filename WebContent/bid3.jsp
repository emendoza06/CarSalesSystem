...
<%@page import = "com.user.bid3" %>

    <%@page import = "com.servlet.bid3Servlet" %>
<%bid3 bid3 = (bid3)session.getAttribute("bid3"); %>
...
<div class = "container">
	...
	<div class = "col-md-4">
		...
		<h2 class="myPreferences">*Starting bids at 10% off original price. </h2>
		<style>
		h2.myPreferences{color:white;}
		</style>
		<br>
		<form action = "bid3Servlet" method = "get">
		<div class = "form-group">
		<br>
 <input type = "text" name = "bid3" placeholder = "Starting bid $42,000"><br>
