<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import = "com.user.bid2" %>

    <%@page import = "com.servlet.bid2Servlet" %>
<%bid2 bid2 = (bid2)session.getAttribute("bid2"); %>
...
<div class = "container">
	...
	<div class = "col-md-4">
		...
		<br>
		<form action = "bid2Servlet" method = "get">
		<div class = "form-group">
		<br>
 <input type = "text" name = "bid2" placeholder = "Starting bid $16,000"><br>
